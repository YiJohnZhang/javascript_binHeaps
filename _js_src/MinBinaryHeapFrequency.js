//	John Zhang
//	https://github.com/YiJohnZhang/javascript_nodal_DS_w_OOP/blob/main/_js_src/leetcode_MinBinaryHeapFrequency.js
//	variant for handling associated data where the priority could represent a frequency.
//	idea: negate all eleements to mimic a max bin heap.

class MinBinaryHeapFrequency{
	...
	static willSwapDown(incumbentIndex, contendingIndex){
		...
		return this.arrayRepresentation[incumbentIndex][0] > this.arrayRepresentation[contendingIndex][0];
		//	elementValue = [ sortableValue, informationLinkedToValue ]
			// because maps will be weirdly handled
